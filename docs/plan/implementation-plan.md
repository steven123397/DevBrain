...
Detailed long-term modeling notes live in `docs/design/future-data-model.md`.
...
**Files:**
- Modify: `README.md`
- Modify: `docs/design/product-requirements.md`
- Modify: `docs/plan/implementation-plan.md`
